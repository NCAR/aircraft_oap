...
/* -------------------------------------------------------------------- */
Config::Config() : _code("SH"), _type("F2DS"), _timeOffset(0), _raw4KbuffersOnly(false), _stuckBitRejection(true), _storeCompressed(false), _resolution(10), _nDiodes(128), _clockFreq(20), _waveLength(785)
